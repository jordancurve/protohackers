...
e.g. 10000
Check
Once you've implemented your server, host it somewhere accessible from the public Internet, and input its IP address and port number.

Your server will then be checked with automated tests.
